...
class Controller(pyglet.window.Window):
    def __init__(self, ancho, alto, titulo):
        ...
        self.Estado_Programa = {"seleccion": 0, 
                                "Key_Cool_Down": 0,
                                "transicion": False, 
                                "Offset_Inicial": np.array([0, 0, 3.263]),
                                "Offset_Final": np.array([0, 0, 3.263]),  #valores por defecto de la posicion del centro de la camara, y a donde miramos.
                                "Offset_Actual": np.array([0, 0, 3.263]),
                                "Vista_Inicial": np.array([0, 0, 3.263]),
                                "Vista_Final": np.array([0, 0, 3.263]),
                                "Vista_Actual": np.array([0, 0, 3.263])}
        self.init()
...
garaje.add_node("Vehiculo_3", attach_to = "Plataforma_3", transform = tr.translate(0, 0.29, 0) @ tr.rotationX(-np.pi / 2))
...
garaje.add_node("Ruedas_3", attach_to = "Vehiculo_3", transform = tr.translate(0, 0, -0.13) @ tr.uniformScale(0.19))
...
###########################################################################################################################
    ...
    if np.sqrt(np.square(ventana.Estado_Programa["Offset_Final"][0] - ventana.Estado_Programa["Offset_Actual"][0]) + np.square(ventana.Estado_Programa["Offset_Final"][2] - ventana.Estado_Programa["Offset_Actual"][2])) > 0.1:
        ...
        ventana.Estado_Programa["Offset_Actual"] = transicion_suave(dt, ventana.Estado_Programa["Offset_Inicial"], ventana.Estado_Programa["Offset_Final"], ventana.Estado_Programa["Offset_Actual"])
